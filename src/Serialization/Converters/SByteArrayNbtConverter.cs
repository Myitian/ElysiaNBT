...
public class SByteArrayNbtConverter :
    NbtConverter<ICollection<sbyte>>,
    IReadOnlyNbtConverter<sbyte[]>
{
    public static readonly SByteArrayNbtConverter Instance = new();
    public override FrozenSet<NbtTagType> TargetTagTypes => SharedObjects.ByteArray;
    public override FrozenSet<NbtTagType> AcceptedTagTypes => SharedObjects.ListByteArray;
