...
public class ULongArrayNbtConverter :
    NbtConverter<ICollection<ulong>>,
    IReadOnlyNbtConverter<ulong[]>
{
    public static readonly ULongArrayNbtConverter Instance = new();
    public override FrozenSet<NbtTagType> TargetTagTypes => SharedObjects.LongArray;
    public override FrozenSet<NbtTagType> AcceptedTagTypes => SharedObjects.ListLongArray;
