...
public sealed class QuaternionNbtConverter : NbtConverter<Quaternion>, IInstance<QuaternionNbtConverter>
{
    public static QuaternionNbtConverter Instance { get; } = new();
