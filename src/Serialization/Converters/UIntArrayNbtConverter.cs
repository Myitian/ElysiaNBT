...
public class UIntArrayNbtConverter :
    NbtConverter<ICollection<uint>>,
    IReadOnlyNbtConverter<uint[]>
{
    public static readonly UIntArrayNbtConverter Instance = new();
    public override FrozenSet<NbtTagType> TargetTagTypes => SharedObjects.IntArray;
    public override FrozenSet<NbtTagType> AcceptedTagTypes => SharedObjects.ListIntArray;
