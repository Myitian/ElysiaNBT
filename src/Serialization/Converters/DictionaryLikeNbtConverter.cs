...
{
    public static readonly DictionaryLikeNbtConverter<T> Instance = new();
...
{
    public static readonly DictionaryLikeNbtConverter Instance = new();
    public override FrozenSet<NbtTagType> TargetTagTypes => SharedObjects.Compound;
    public override FrozenSet<NbtTagType> AcceptedTagTypes => SharedObjects.Compound;
    ...
    {
        return context.GetDefaultReadConverter<Dictionary<string, object>>().ReadNbtBody(reader, context);
    }
    public override Dictionary<string, object> ReadNbt(INbtReader reader, NbtSerializerContext context)
    {
        return context.GetDefaultReadConverter<Dictionary<string, object>>().ReadNbt(reader, context);
    }
    public override NbtTagType GetTargetTagType(NbtSerializerContext? context = null)
    {
        return NbtTagType.Compound;
