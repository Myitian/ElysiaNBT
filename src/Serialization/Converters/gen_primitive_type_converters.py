...
namespace NBTParserTest.Myitian.NBT.Serialization.Converters;

public class {0}NbtConverter : NbtConverter<{1}>
{{
    public static readonly {0}NbtConverter Instance = new();
    public override FrozenSet<NbtTagType> TargetTagTypes => SharedObjects.{2};
    public override FrozenSet<NbtTagType> AcceptedTagTypes => {3};
...
public class {0}ArrayNbtConverter :
    NbtConverter<ICollection<{1}>>,
    IReadOnlyNbtConverter<{1}[]>
{{
    public static readonly {0}ArrayNbtConverter Instance = new();
    public override FrozenSet<NbtTagType> TargetTagTypes => SharedObjects.{2}Array;
    public override FrozenSet<NbtTagType> AcceptedTagTypes => SharedObjects.List{2}Array;
