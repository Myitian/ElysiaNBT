...
[MemoryDiagnoser]
[MarkdownExporter]
public class Scoreboard_NBT
{
    static byte[] Data;
    [GlobalSetup]
    public void Setup()
    {
        using Stream s = Program.Entries.First(e => e.Name == "scoreboard.nbt").Open();
    ...
    public void Benchmark_ElysiaNBT_ToObject()
    {
        ...
        ElysiaNBT.BinaryNbtOptions options = ElysiaNBT.BinaryNbtOptions.JavaEdition;
        options.GenericOptions.HasRootName = true;
        Scoreboard result = ElysiaNBT.Serialization.NbtSerializer.DeserializeBinary<Scoreboard>(stream, options);
    }
    ...
    {
        using MemoryStream stream = new(Data);
        Konves.Nbt.Serialization.NbtSerializer serializer = new(typeof(Scoreboard));
    ...
    public void Benchmark_NbtLib_Debug_ToObject()
    {
        ...
        Scoreboard result = deserializer.DeserializeObject<Scoreboard>(stream);
    }
